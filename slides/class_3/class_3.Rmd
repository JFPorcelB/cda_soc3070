...
style_duo_accent(primary_color = "#79A58F", secondary_color = "#B9B9CE" ,
...
table(X) %>% 
  ...
  scale_fill_manual(values = "#B9B9CE") +
  theme_minimal() +
...
ggplot(data = PMF_df, aes(x = factor(x), y = PMF)) +
  geom_bar(stat = "identity", color = "black", fill = "#B9B9CE", width = 1, alpha=0.8) +
  labs(x = "Outcome",
       y = "P(X = x)") +
  scale_x_discrete(labels = c("Sello (0)", "Cara (1)")) +
  scale_color_manual(values = "#B9B9CE") +
  scale_fill_manual(values = "#B9B9CE") +
  theme_minimal() +
...
ggplot(data = PMF_df, aes(x = factor(x), y = PMF)) +
  ...
  scale_x_discrete(labels = as.character(0:10)) +
  scale_color_manual(values = "black") +
  scale_fill_manual(values = c("#B9B9CE", "blue")) +
  theme_minimal() +
  theme(panel.background = element_rect(color = "black", fill = NA, size = 1))  # This line adds the inner border
...
ggplot() +
  ...
  geom_segment(data = CDF_df, aes(x = start_x, y = CDF, xend = x, yend = CDF), color = "#B9B9CE", size = 1.2) +
  # Vertical segments for CDF
  geom_segment(data = CDF_df, aes(x = x-1, y = start_CDF, xend = x-1, yend = CDF), color = "#B9B9CE", size = 1.2) +
...
if (resultados$gana[1] == "Chile") {
  print(resultados)
  include_graphics("/Users/mauricio/Library/Mobile Documents/com~apple~CloudDocs/Teaching/ISUC/2023_2_categorical_data_analysis/repo/slides/class_3/chile.jpg")
} else {
  print(resultados)
  include_graphics("/Users/mauricio/Library/Mobile Documents/com~apple~CloudDocs/Teaching/ISUC/2023_2_categorical_data_analysis/repo/slides/class_3/brasil.jpg")
}

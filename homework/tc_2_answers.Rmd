...
\begin{align*}
\mathbb{P}(H_{1} \text{ verdadera} \mid \text{rechazar } H_{0}) &= \frac{\mathbb{P}(\text{rechazar } H_{0}  \mid H_{1} \text{ verdadera})\mathbb{P}(H_{1} \text{ verdadera})}{\mathbb{P}(\text{rechazar } H_{0})} \\ \\
&= \frac{\mathbb{P}(\text{rechazar } H_{0}  \mid H_{1} \text{ verdadera})\mathbb{P}(H_{1} \text{ verdadera})}{\mathbb{P}(\text{rechaza } H_{0} \mid H_{1}  \text{ verdadera})\mathbb{P}(H_{1}  \text{ verdadera}) +   
    \mathbb{P}(\text{rechaza } H_{0} \mid H_{1}  \text{ falsa})\mathbb{P}(H_{1}  \text{ falsa})} \\ \\
&= \frac{\text{power} \times 0.5}{\text{power} \times 0.5 + \alpha \times 0.5} = \frac{\text{power}}{\text{power} + \alpha} \\ \\
&= \frac{0.8}{0.8 + 0.05} = 0.94
\end{align*}
...
\begin{align*}
\mathbb{P}(H_{1} \text{ falsa} \mid \text{rechazar } H_{0}) &= \frac{ \mathbb{P}(\text{rechazar } H_{0} \mid H_{1} \text{ falsa})\mathbb{P}(H_{1} \text{ falsa})}{\mathbb{P}(\text{rechazar } H_{0})} \\ \\
&= \frac{ \mathbb{P}(\text{rechazar } H_{0} \mid H_{1} \text{ falsa})\mathbb{P}(H_{1} \text{ falsa})}
{\mathbb{P}(\text{rechaza } H_{0} \mid H_{1}  \text{ verdadera})\mathbb{P}(H_{1}  \text{ verdadera}) +   
    \mathbb{P}(\text{rechaza } H_{0} \mid H_{1}  \text{ falsa})\mathbb{P}(H_{1}  \text{ falsa})}  \\ \\
&= \frac{\alpha \times 0.5}{\text{power} \times 0.5 + \alpha \times 0.5} = \frac{\alpha}{\text{power} + \alpha} \\ \\    
&= \frac{0.05}{0.8 + 0.05} = 0.06
\end{align*}

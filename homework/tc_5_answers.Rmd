...
2. Usa el método de Bootstrap  para crear un intervalo de confianza al 95% para la diferencia entre los efectos marginales para hombres y mujeres reportados en la pregunta 1. 

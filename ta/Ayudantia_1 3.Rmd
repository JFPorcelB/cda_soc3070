...
author: "Ayudantía 1 - Revisión Tarea 1"
date: Roberto Velázquez
output: 
  beamer_presentation:
    theme: "Copenhagen"
    colortheme: "dolphin"
...
Revisemos ahora cómo resolver la Tarea 1 en R:

```{r echo=TRUE, message=FALSE, warning=FALSE}
#Crearemos los objetos con los valores 
...
8) $ln(\frac{y}{c})=\alpha+\beta x$ entonces $y=?$

$ln(\frac{y}{c})=\alpha+\beta x$

$\frac{y}{c}=e^{\alpha+\beta x}$

$y=e^{\alpha}*e^{\beta x}*c$
